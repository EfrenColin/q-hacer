<template>
    ...
    <div class="max-w-7xl mx-auto" id="bg">
                ...
                <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                    <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                        <div class="text-black font-black text-2xl flex items-center">
                            <span class="w-6 h-6 rounded-full bg-blue-500 mr-4"></span> Q-hacer
                        </div>
                    </a>
                    <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
                        <Link :href="route('login')" class="py-2 px-6 flex hover:text-blue-500">
                            Acceder
                        </Link>
                    </nav>
                    <Link  :href="route('register')" class="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">
                        Registrate
        ...
        <div class="container mx-auto px-6 pt-8 pb-10">
            <div class="flex flex-col sm:flex-row w-full ">
                <div class="relative sm:w-1/3">
                    <span class="text-6xl font-black text-gray-200 absolute top-0 left-0">Eficaz</span>
                    <div class="mt-8 ml-6 relative z-10 flex flex-col">
                        <h4 class="font-bold uppercase font-xs leading-none text-transparent bg-clip-text bg-gradient-to-br from-orange-400 to-pink-600">Divida los grandes proyectos</h4>
                        <p class="text-base text-center text-white font-semibold leading-none mt-8 p-4 shadow-md hover:shadow-2xl rounded-full  h-24
                        bg-gradient-to-br  text-white from-orange-400 to-pink-600">
                            No pierdas la concentración. <br> Trabaja en las cosas importantes, disfruta del flujo de tu trabajo y visualiza tu progreso.
                        </p>
                    </div>
                </div>
                <div class="relative sm:w-1/3">
                    <span class="text-6xl font-black text-gray-200 absolute top-0 left-0">Practico</span>
                    <div class="mt-8 ml-6 relative z-10 flex flex-col">
                        <h4 class="font-bold uppercase font-xs leading-none text-transparent bg-clip-text bg-gradient-to-br from-green-400 to-cyan-500">Una herramienta hecha para ti</h4>
                        <p class="text-base text-center text-white font-semibold leading-none mt-8 p-4 bg-white shadow-md hover:shadow-2xl rounded-full  h-24
                        bg-gradient-to-br  text-white from-green-400 to-cyan-500">
                            Recupera tu claridad y tranquilidad sacando todas esas tareas de tu cabeza para ponerlas en tu lista de tareas
                            (sin importar dónde estés o el dispositivo que estés utilizando).
                        </p>
                    </div>
                </div>
                <div class="relative sm:w-1/3">
                    <span class="text-6xl font-black text-gray-200 absolute top-0 left-0">Organizado</span>
                    <div class="mt-8 ml-6 relative z-10 flex flex-col">
                        <h4 class="font-bold uppercase font-xs leading-none text-transparent bg-clip-text bg-gradient-to-br from-fuchsia-500 to-purple-600">Un lugar para cada idea</h4>
                        <p class="text-base text-center text-white font-semibold leading-none mt-8 p-4 bg-white shadow-md hover:shadow-2xl rounded-full  h-24
                         bg-gradient-to-br  text-white from-fuchsia-500 to-purple-600">
                            Agregue tareas a su cartera de pedidos cuando surjan ideas. <br> Agrúpelos con etiquetas, discuta los detalles con su equipo y realice un seguimiento de todo.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <footer class="text-gray-600 body-font">
            <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                ...
                <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2021 Q-Hacer —
                    <a href="#" class="text-gray-600 ml-1" target="_blank">@FR3DO_X</a>
                </p>
